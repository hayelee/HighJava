...
/*
  ...
  EUC-KR방식으로 확장하였기 때문에 MS949라고도 부른다.
  ...
  CP949는 EUC-KR의 확장이며, 하위 호환성이 있다.
   ...
   - 유니코드 => 서로 다른 문자 인코딩을 사용하는 컴퓨터간의 문서교환에 어려움을 겪게 되고,
                               이런 문제점을 해결하기 위해 전세계의 모든 문자를 하나의 통일된 문자집합(CharSet)으로 표현하게 되었음.
...
//			isr = new InputStreamReader(fis, "UTF-8"); // 인코딩 정보가 맞지 않으면 글씨가 깨져서 보임
			isr = new InputStreamReader(fis, "EUC-KR"); // ANSI계열은 EUC-KR로 해도 됨
