...
/*
	...
	2. 웹애플리케이션당 1개씩 생성됨. 애플리케이션을 대표하는 객체이다.
 ...
 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 자주 쓸만한 것들은 req에 다 들어있음
		ServletContext ctx = req.getServletContext();
		ctx = getServletContext();
		
		System.out.println("서블릿 컨텍스트의 기본 경로 : " + ctx.getContextPath()); //ContextPath=>애플리케이션의 경로정보
		...
		System.out.println("파일에 대한 MINE타입 정보 : " + ctx.getMimeType("abc.mp3"));
		...
		// 로깅작업
		ctx.log("서블릿 컨텍스트를 이용한 로깅작업 중입니다만...");
	}
