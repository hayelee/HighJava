...
public class T03ServletParameterTest extends HttpServlet {
	 ...
	 */
		req.setCharacterEncoding("UTF-8"); // 데이터를 꺼낼때는 encoding정보를 먼저 꺼내야 한글이 안꺠짐
		...
		resp.setContentType("text/html;charset=utf-8"); // encoding정보를 한줄로 줄임 (= resp.setCharacterEncoding("UTF-8");)
