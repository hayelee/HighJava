...
//		// 2-2. update 작업 연습
		...
		try {
			...
			int cnt = sqlSession.delete("member.deleteMember", "a006");
		...
		try {
			memList = sqlSession.selectList("member\selectAllMember");
		...
		try {
				MemberVO mv4 = (MemberVO) sqlSession.selectOne("memberTest.selectMember", "aaa");
