...
public class T06TreeSetTest {
	public static void main(String[] args) {
		...
		Collections.shuffle(abcList); // 알파벳 무작위로 섞은 것
		...
		// Head 기준 숫자보다 작은 것, Tail 기준 숫자보다 큰 것

		// TreeSet에 저장된 자료 중 특정 자료보다 작은 자료를 찾아서 SortedSet으로
		// 반환하는 메서드가 있다.
		...
		System.out.println("K(포함)부터 (미포함)까지 : " + ts.subSet("K", false, "N", false));
