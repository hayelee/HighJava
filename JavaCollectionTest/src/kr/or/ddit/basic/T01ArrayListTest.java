...
public class T01ArrayListTest {
	public static void main(String[] args) {
		...
		//List list1 = new LinkedList(); 도 가능
		...
		// 데이터 변경하기(set메서드)
		String temp = (String) list1.set(0, "YYY"); //set에는 리턴값도 존재함
		...
		list1.remove(new Integer("111")); //정수 객체 만들기
